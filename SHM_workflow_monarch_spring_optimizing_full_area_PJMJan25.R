...
#'
scriptName<-"SHM_workflow_monarch_spring_optimizing_full_area_PJMJan25.R"
...
if (external_data=="yes"){
  presence_observations <- read_csv(paste0(rootdir, "data/monarchs/MergedMonarchs_202212_PJM_select_ras.csv"))
    ...
    #dplyr::filter(!Life_Stage%in%c("Larva","Egg" , "Pupa", "Larva/Egg" , "Pupa/Larva",   "Pupa/Larva/Egg","Egg/larvae" )) %>%
...
if (domain == "terrestrial"){
  ...
  "FwPond330", "ForWet330", "HerED330", "NectCt330")
